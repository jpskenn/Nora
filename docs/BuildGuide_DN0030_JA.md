...
- [組み立て手順](#組み立て手順)
  ...
  - [スイッチプレートにシートを貼り付ける](#スイッチプレートにスペーサーシートを貼り付ける)
...
スイッチプレートに貼り付けるスペーサーシートを切断するため、はさみなども用意してください。
...
Kailh Choc用ソケットを取り付けるパッド（基板上の四角い銀色の部分）をショートさせて、基板回路が電気的に正しく反応することを確認します。  
...
ピンセットなどの電気を通すものを使い、パッドをショートさせます。
...
基板とスイッチプレートの隙間を埋めるスペーサーシートを、スイッチプレート裏側へ貼り付けます。  
...
1. スペーサーシートをはさみなどで切り離し、スイッチプレート裏側の貼り付け位置を示した箇所へ、以下の優先順に貼り付けます。
...
1. プレートにスイッチをはめ込みつつ、そのまま基板のソケットへスイッチ端子を差し込んで、スイッチを取り付けます。
  基板にネジのアイコンが描かれた箇所は、ケースネジにスイッチが重なるため、この手順では取り付けません。
...
1. ケースネジ穴と基板のネジ穴の位置を合わせ、6箇所をネジで仮止めします。  
  左上の1箇所のみ、ケース付属のネジを使用します。  
  それ以外の、左端、右端、右上、中央、中央下の5箇所は、ネジ穴とスイッチが重なるため、キット同梱のネジ（M2 4mm 低頭）を使用します。  

1. ケースに対して基板の位置が上下左右の真ん中になるように調整します。

1. ネジが軽く止まる程度まで締めて基板を固定します。

1. ケース中央のネジ穴に重なるスイッチを、足を加工して取り付けます。
  3ピンのスイッチは、加工せず、そのまま取り付けできます。
  5ピンのスイッチは、左右2本のプラスチックピンのうち、ネジ穴に干渉する方の足をニッパーなどで切断します。
...
正しい位置にジャンパしていても点灯しない場合は、LEDの取り付け確認をおこないます。
...
正しい位置にジャンパされていても点灯しない場合は、LEDの取り付けに原因があると考えられます。
...
(すでに組み立てに取り掛かっていますが)組み立て前の確認の、接続の確認とソケット用パッドの確認を行なってください。
