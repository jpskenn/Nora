...
- [組み立て手順](#組み立て手順)
  ...
  - [Mill-Maxソケットの取り付け](#mill-maxソケットの取り付け)
  - [スイッチプレートにシートを貼り付ける](#スイッチプレートにシートを貼り付ける)
  - [スタビライザーを組み立てる](#スタビライザーを組み立てる)
  - [スイッチプレートにスタビライザーを取り付ける](#スイッチプレートにスタビライザーを取り付ける)
  - [スイッチの取り付け](#スイッチの取り付け)
  - [ケースへの取り付け](#ケースへの取り付け)
  - [仕上げ](#仕上げ)
- [参考](#参考)
...
温度の設定ができない場合は、以下の手順で数える時間を半分にして試します。
...
3、4：  
はんだをこて先に当てて溶かし、端子とパッドにはんだを行き渡らせて、はんだを離します。
こて先はグリグリ動かしません。はんだ溶けて、濡れ広がっていくような具合です。
...
基板の中央下部に、はんだ付け練習用のスルーホールを用意しています。  
...
ソケットとスルーホールの間あたりへ、はんだを少しだけ押し付けて溶かします。  
溶けたはんだが、ソケットとスルーホールの隙間に流れ込みます。  
ソケットの内側にはんだが入ってしまわないよう、少しずつおこないます。

はんだが隙間から少しだけ出ている程度まで流し込んだら完了です。
...
以下の写真に示す貼り付け位置を確認し、シートをはさみなどで切り離して貼り付けます。
