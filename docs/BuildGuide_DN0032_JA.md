...
1. LEDから出ている4本の端子のうち、角が斜めになっている1本が基板に描かれた印に合うようにして、基板の穴にはめこみます。  
    **:exclamation: 注意：行ごとに、LEDを取り付ける方向が異なります。**  
...
- :exclamation: 最下行の親指部分、左右のスペースキーとして使用するスイッチ（2個）は、**上下逆向き**に取り付けます。  
  LEDが眩しく感じる場合は、スイッチのLED窓内側へマスキングテープなどを貼ったり、黒マジックで塗ったりして減光します。

- スイッチのスイッチプレートへのはめ込み具合が、きつい・ゆるいスイッチがあります。  
  Choc 赤、茶は、きつめかもしれません。  
  Red Crystalは少し緩めです。
...
1. プレートのおもて側から、1・3・5行目の左右の端6箇所に、スイッチをパチンとはめ込みます。  
    ...
    スイッチによってはめ込み具合に差がありますが、少しゆるめの固定でも問題ありません。
...
1. キーキャップ、ロータリーエンコーダのノブを取り付けます。
    ...
    キーの配置は、[KLE: Nora, Fearless Wings family](http://www.keyboard-layout-editor.com/#/gists/568990362f215776aa93e3b90064f241)を参考に、好みに合わせて取り付けてください。
...
- 基板の振動防止
    ...
    （Pi PICO取り付け用に、ボトムプレートの一部を切り取っています）
...
以下のリンク先をご覧ください。  
各レイアウトに対応するChoc V1用キーキャップと、使用感などをまとめまています。

[資料：Nora用キーキャップ選び方ガイド](KeycapsGuide.md)
